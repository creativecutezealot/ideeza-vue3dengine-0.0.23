...
export default class PS {
  ...
  _createBody3D () {
    ...
    const cylinder = BABYLON.MeshBuilder.CreateBox('box', options, this.scene)

    var options2 = {
      diameterTop: parseFloat(this.metadata['dimensions']['e_max_body_span']),
      diameterBottom: parseFloat(this.metadata['dimensions']['e_max_body_span']),
      height: parseFloat(this.metadata['dimensions']['maximum_height']),
      tessellation: 32
    }
    ...
    sphere.position.x = parseFloat(this.metadata['dimensions']['d_max_body_span']) / 2
    sphere2.position.x = -parseFloat(this.metadata['dimensions']['d_max_body_span']) / 2
