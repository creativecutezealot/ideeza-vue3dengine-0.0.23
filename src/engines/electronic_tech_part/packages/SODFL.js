...
export default class SODFL {
  ...
  _updatePins () {
    ...
    for (let i = 0; i < totalPins; i++) {
      ...
      box.position.z = 0
      box.position.x = ((i % 2 === 0) ? -1 : 1) * (width - parseFloat(this.metadata['dimensions']['max_lead_width_b'])) / 2
  ...
  _createLayer1 () {
    ...
    const width = parseFloat(this.metadata['dimensions']['max_lead_width_b'])
    const length = parseFloat(this.metadata['dimensions']['max_lead_length_l'])
  ...
  _createBody3D () {
    const options = {
      width: parseFloat(this.metadata['dimensions']['max_body_width_e1']),
      height: parseFloat(this.metadata['dimensions']['maximum_height']),
      depth: parseFloat(this.metadata['dimensions']['max_body_length_d'])
    }
  ...
  _getPin () {
    const depth = parseFloat(this.metadata['dimensions']['max_lead_length_l'])
    let width = parseFloat(this.metadata['dimensions']['max_lead_width_b'])
