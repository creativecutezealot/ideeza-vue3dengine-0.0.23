...
export default class SC70 {
  ...
  _updateBody () {
    ...
    body.position.y = parseFloat(this.metadata['dimensions']['minStandoffHeight']) / 2
    this.body = body
    ...
    this.name.position.y = parseFloat(this.metadata['dimensions']['minStandoffHeight']) + height / 2 + 0.01
  }
  ...
  _updatePins () {
    ...
    const width = parseFloat(this.metadata['package_pin']['lead_length_l_max'])
    const height = parseFloat(this.metadata['dimensions']['minStandoffHeight'])
    ...
    const bodyW = parseFloat(this.metadata['dimensions']['bodyWidthRange_e1_max'])
    ...
    for (let i = 0; i < left; i++) {
      box = pin.clone('Clone '+i)
      box.isVisible = true

      box.scaling.x = width
      box.scaling.y = bodyH / 2 + height + parseFloat(this.metadata['dimensions']['minStandoffHeight'])
      box.scaling.z = depth
  ...
  _createLayer1 () {
    ...
    const width = parseFloat(this.metadata['package_pin']['lead_length_l_max'])
    const length = parseFloat(this.metadata['package_pin']['lead_width_b_max'])
  ...
  _createLayer21 () {
    ...
    const x = parseFloat(this.metadata['dimensions']['bodyWidthRange_e1_max']) / 2 - parseFloat(this.metadata['silkscreen']['LineWidth']) / 2
  ...
  _addFSize () {
    ...
    // console.log(this.layer1.position, this.metadata['transform']['position'][1], this.pins[0].scaling.y, height, parseFloat(this.metadata['dimensions']['minStandoffHeight']))
  }
