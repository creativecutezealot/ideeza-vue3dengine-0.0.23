...
export default class HM10 {
 ...
 _updatePackage () {
  ...
  _updatePins () {
    ...
    for (let i = 0; i < nrOfPins1; i++) {
      ...
      if (i < parseInt(this.metadata['package_pin']['number_pins_l'])) {
        ...
        box.position.z = depth - parseFloat(this.metadata['dimensions']['pin_dist_l']) - i * parseFloat(this.metadata['package_pin']['pitch'])
        box.rotation.y = -Math.PI / 2
      }
      else {
        box.position.x = width - boxbbInfo.z
        box.position.z = depth - parseFloat(this.metadata['dimensions']['pin_dist_l']) - (i - parseFloat(this.metadata['package_pin']['number_pins_l'])) * parseFloat(this.metadata['package_pin']['pitch'])
        box.rotation.y = Math.PI / 2
      }
  ...
  _createBody3D () {
    ...
    for (let i = 0; i < 2 * parseInt(this.metadata['package_pin']['number_pins_l']); i++) {
      ...
      if (i < parseInt(this.metadata['package_pin']['number_pins_l'])) {
        ...
        box.position.z = bbInfo.z - parseFloat(this.metadata['dimensions']['pin_dist_l']) - i * parseFloat(this.metadata['package_pin']['pitch'])
      }
      else {
        box.position.x = bbInfo.x - boxbbInfo.z
        box.position.z = bbInfo.z - parseFloat(this.metadata['dimensions']['pin_dist_l']) - (i - parseFloat(this.metadata['package_pin']['number_pins_l'])) * parseFloat(this.metadata['package_pin']['pitch'])
      }
  ...
  _getPin (simpePin = false) {
    ...
    const hole = BABYLON.MeshBuilder.CreateCylinder('pin', { height: parseFloat(this.metadata['dimensions']['maximum_height']), diameter: parseFloat(this.metadata['package_pin']['max_lead_width']), tesselation: 32 }, this.scene)
