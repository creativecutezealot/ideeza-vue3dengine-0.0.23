...
export default class SON {
  ...
  _updatePins () {
    ...
    const width = parseFloat(this.metadata['dimensions']['bodyWidthRange_e_max']) / 2
    const height = parseFloat(this.metadata['dimensions']['maxHeightA']) / 2
    // const depth = parseFloat(this.metadata['dimensions']['bodyLengthRange_d_max']) / 2
    ...
    for (let i = 0; i < totalPins; i++) {
      ...
      if (k % 2 !== 0) {
        box.position.z = (i % k) * parseFloat(this.metadata['thermal_dimensions']['pitch']) - parseFloat(this.metadata['thermal_dimensions']['pitch']) * ((k / 2 < 1) ? 0 : parseInt(k / 2))
      }
      else {
        box.position.z = (i % k) * parseFloat(this.metadata['thermal_dimensions']['pitch']) + parseFloat(this.metadata['thermal_dimensions']['pitch']) / 2 - parseFloat(this.metadata['thermal_dimensions']['pitch']) * (k / 2)
      }

      box.rotation.y = Math.PI / 2
      box.position.x = ((i < parseInt(totalPins / 2)) ? -1 : 1) * (width + boxbbInfo.z)
  ...
  _createLayer1 () {
    ...
    const length = parseFloat(this.metadata['thermal_dimensions']['leadWidthRange_l_max'])
    const width = parseFloat(this.metadata['thermal_dimensions']['leadWidthRange_b_max'])
  ...
  _addFSize () {
    ...
    const height = parseFloat(this.metadata['dimensions']['maxHeightA']) + 0.2 // 0.2 - height of pin
  ...
  _getPin () {
    const depth = parseFloat(this.metadata['thermal_dimensions']['leadWidthRange_l_max'])
    let width = parseFloat(this.metadata['thermal_dimensions']['leadWidthRange_b_max'])
