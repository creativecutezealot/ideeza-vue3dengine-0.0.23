...
export default class LED0805 {
  ...
  async _load3dObjects () {
    ...
    ////// pins ////////
    const pin = await Component.import3dObject('user-aeb9796a6cd0441cb82a071e7a09b5a7.glb', this.scene)
    if (!pin) {
  ...
  _updateBody () { 
    ...
    body.material = Component.createMaterial(this.scene, 'plastic', '#eeeeee')
  ...
  _updatePins () {
    ...
    const height = parseFloat(this.metadata['dimensions']['maximum_height2'])
