export default {
  ...
  // package: '',
  dimensions: {
    d1_min_body_length: '8.89',
    d1_max_body_length: '9.04',
    e1_min_body_length: '8.89',
    e1_max_body_length: '9.04',
    pin_location: '0',
    min_standoff: '0.1', // 0.58
    maximum_height: '4.57'
  },
  package_pin: {
    min_lead_width: '0.33',
    max_lead_width: '0.53',
    d_min_lead_span: '9.78',
    d_max_lead_span: '10.03',
    e_min_lead_span: '9.78',
    e_max_lead_span: '10.03',
    min_lead_length: '1.5',
    max_lead_length: '2',
    e_pitch: '1.27',
    e_number_pins: '8',
