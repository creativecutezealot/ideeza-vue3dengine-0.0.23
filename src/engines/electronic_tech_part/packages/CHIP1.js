...
export default class CHIP1 {
  ...
  _updateBody () { 
    ...
    // w h d
    const width = parseFloat(this.metadata['dimensions']['max_body_range_e'])
    const height = parseFloat(this.metadata['dimensions']['maximum_height'])
    const depth = parseFloat(this.metadata['dimensions']['max_body_width_d'])
  ...
  _updatePins () {
    ...
    const width = parseFloat(this.metadata['dimensions']['max_body_width_t'])
    const height = parseFloat(this.metadata['dimensions']['maximum_height'])
    const depth = parseFloat(this.metadata['dimensions']['max_body_width_d'])
    const bodyDim = parseFloat(this.metadata['dimensions']['max_body_range_e'])
    ...
    for (let i = 0; i < nrOfPins; i++) {
      ...
      box.isVisible = true
      box.scaling.x = width + 0.05
      box.scaling.y = height + 0.025
      box.scaling.z = depth + 0.05
  ...
  _createLayer1 () {
    ...
    const width = parseFloat(this.metadata['dimensions']['max_body_width_t']) + 0.05
    const length = parseFloat(this.metadata['dimensions']['max_body_width_tw']) + 0.05
