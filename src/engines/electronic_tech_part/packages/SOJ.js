...
export default class SOJ {
  ...
  _createLayer1 () {
    ...
    const width = parseFloat(this.metadata['dimensions']['lead_width_b_max'])
    const length = parseFloat(this.metadata['dimensions']['lead_length_l_max'])
