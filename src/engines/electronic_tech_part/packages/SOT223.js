...
export default class SOT223 {
  ...
  _updateBody () { 
    ...
    // w h d
    const width = parseFloat(this.metadata['dimensions']['bodyWidthRange_e1_max'])
    const height = parseFloat(this.metadata['dimensions']['maxHeightA'])
    const depth = parseFloat(this.metadata['dimensions']['bodyLengthRange_e1_max'])
  ...
  _updatePins () {
    ...
    const width = parseFloat(this.metadata['dimensions']['bodyWidthRange_e1_max']) / 2
    // const depth = parseFloat(this.metadata['dimensions']['bodyLengthRange_e1_max']) / 2
    ...
    for (let i = 0; i < (totalPins - 1); i++) {
      ...
      box.position.x = -(width + boxbbInfo.x)
    ...
    box = Component._create2DShape(0, parseFloat(this.metadata['package_pin']['lead_width_l_max']), parseFloat(this.metadata['package_pin']['lead_width_b2_max']), 0.1, this.scene)

    box.metadata = {
      'width': parseFloat(this.metadata['package_pin']['lead_width_l_max']),
      'length': parseFloat(this.metadata['package_pin']['lead_width_b2_max'])
    }
  ...
  _createLayer1 () {
    ...
    const width = parseFloat(this.metadata['package_pin']['lead_width_l_max'])
    let length = parseFloat(this.metadata['package_pin']['lead_width_b_max'])
    ...
    for (let i = 0; i < totalPins; i++) {
      if (i > totalPins - 2) {
        ...
        length = parseFloat(this.metadata['package_pin']['lead_width_b_max'])
      }
