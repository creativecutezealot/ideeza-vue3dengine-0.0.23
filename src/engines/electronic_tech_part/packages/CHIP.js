...
export default class CHIP {
  ...
  _updateBody () { 
    ...
    // w h d
    const width = parseFloat(this.metadata['dimensions']['max_body_span_e'])
    const height = parseFloat(this.metadata['dimensions']['maximum_height'])
    const depth = parseFloat(this.metadata['dimensions']['max_body_span_d'])
  ...
  _updatePins () {
    ...
    const width = parseFloat(this.metadata['dimensions']['max_body_span_e']) / 2
    // const depth = parseFloat(this.metadata['dimensions']['max_body_span_d'])
    const height = parseFloat(this.metadata['dimensions']['maximum_height']) / 2

    var totalPins = parseInt(this.metadata['package_pin']['number_of_pins'])
    ...
    for (let i = 0; i < totalPins; i++) {
      ...
      box.position.x = ((i < parseInt(totalPins / 2)) ? -1 : 1) * width
  ...
  _createLayer1 () {
    ...
    const width = parseFloat(this.metadata['package_pin']['lead_width_max'])
    const length = parseFloat(this.metadata['package_pin']['lead_length_max'])
  ...
  _createBody3D () {
    const options = {
      width: parseFloat(this.metadata['dimensions']['max_body_span_e']),
      height: parseFloat(this.metadata['dimensions']['maximum_height']),
      depth: parseFloat(this.metadata['dimensions']['max_body_span_d'])
    }
  ...
  _getPin () {
    const depth = parseFloat(this.metadata['package_pin']['lead_length_max'])
    let width = parseFloat(this.metadata['package_pin']['lead_width_max'])
