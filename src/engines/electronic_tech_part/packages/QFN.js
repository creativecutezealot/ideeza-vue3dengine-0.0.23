...
export default class QFN {
  ...
  _updateBody () {
    ...
    this.name.position.y = parseFloat(this.metadata['dimensions']['min_standoff']) + height / 2 + 0.01
  }
  ...
  _updatePins () {
    ...
    const bodyD = parseFloat(this.metadata['dimensions']['d_max_body_span'])
    const bodyW = parseFloat(this.metadata['dimensions']['e_max_body_span'])
  ...
  _createLayer1 () {
    ...
    for (let i = 0; i < totalPins; i++) {
      ...
      if (box1.rotation.y < -3) {
        ...
        if (box1.rotation.y == 0) {
          box1.position.x += width / 3
        }
        else {
          if (box1.rotation.y < 0) {
            box1.position.z += width / 3
          }
          else {
            box1.position.z -= width / 3
          }
  ...
  _createLayer21 () {
    ...
    const x = parseFloat(this.metadata['dimensions']['e_max_body_span']) / 2 - parseFloat(this.metadata['silkscreen']['LineWidth']) / 2
    const z = parseFloat(this.metadata['dimensions']['d_max_body_span']) / 2 - parseFloat(this.metadata['silkscreen']['LineWidth']) / 2
