...
import { pcb3D } from '../../../engines/electronic_user_d' 
...
export default {
  ...
  props: {
    ...
    compEnable: {             // show/hide component - by default hide
      type: Boolean,
      default: false
    },   
  ...
  methods: {
    ...
    autoScale() { // to be called from parent on rescale component
      return pcb3D.autoScale()
    },
