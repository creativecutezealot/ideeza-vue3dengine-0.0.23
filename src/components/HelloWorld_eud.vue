<template>
  <div class="hello">
    ...
    <input type="checkbox" v-model="visible3d" />Toggle2d3d
    <input type="checkbox" v-model="compEnable" />EnableComp
...
<script>
import sceneComp from './engines/electronic_user_d/sceneComp'
